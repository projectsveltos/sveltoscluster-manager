[![CI](https://github.com/projectsveltos/sveltoscluster-manager/actions/workflows/main.yaml/badge.svg)](https://github.com/projectsveltos/sveltoscluster-manager/actions)
[![OpenSSF Scorecard](https://api.securityscorecards.dev/projects/github.com/projectsveltos/sveltoscluster-manager/badge)](https://scorecard.dev/viewer/?uri=github.com/projectsveltos/sveltoscluster-manager)
[![CodeQL](https://github.com/projectsveltos/sveltoscluster-manager/actions/workflows/codeql.yaml/badge.svg)](https://github.com/projectsveltos/sveltoscluster-manager/actions/workflows/codeql.yaml)
[![Release](https://img.shields.io/github/v/release/projectsveltos/sveltoscluster-manager)](https://github.com/projectsveltos/sveltoscluster-manager/releases)
...
sveltoscluster-manager is the microservice in charge of continuously verifying connectivity with registered clusters.
