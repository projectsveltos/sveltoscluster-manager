...
import (
	...
	"github.com/projectsveltos/sveltoscluster-manager/internal/test/helpers"
)
...
func getClusterProfileReconciler(c client.Client) *controllers.SveltosClusterReconciler {
	return &controllers.SveltosClusterReconciler{
		Client: c,
		Scheme: scheme,
	}
}
